#!/usr/bin/env python3
"""RackForge's safe, dependency-free KeyLab Essential mk3 OLED bridge.
...
CLEAR_SCREEN = sysex(bytes.fromhex("04 01 60 61 00"))
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--demo", action="store_true", help="preparar la demostración DOOM de rackforge"
    )
    parser.add_argument(
        "--port",
