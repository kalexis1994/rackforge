...
impl Default for ConcertGrand {
    fn default() -> Self {
        let mut piano = Self {
            ...
            cal: [
                [
                    0.8445, 2.3440, 0.5097, 0.3392, 2.2448, 0.9236, 1.6842, 1.0000, 0.5654,
                ],
                [
                    0.7931, 2.7660, 0.2883, 0.3392, 0.9540, 0.4180, 0.4024, 1.0000, 1.1731,
                ],
                [
                    0.2754, 2.4965, 0.5098, 0.2609, 0.9169, 0.5434, 0.8348, 1.0000, 0.5849,
                ],
                [
                    0.3239, 1.9095, 0.9228, 0.3411, 0.5580, 0.4932, 0.2500, 1.0000, 1.2494,
                ],
                [
                    2.1186, 2.4650, 1.2806, 0.2565, 0.6582, 0.3269, 1.3111, 1.0000, 3.0497,
                ],
                [
                    3.5576, 2.1321, 1.3269, 2.6568, 0.2658, 0.4731, 0.2952, 1.0000, 0.5276,
                ],
                [
                    4.0000, 0.6556, 1.8725, 1.0000, 0.2934, 0.7958, 0.2500, 1.0000, 0.9942,
                ],
                [
                    0.8523, 0.9026, 4.0000, 3.9996, 0.2500, 1.0000, 1.9942, 1.0000, 0.2500,
                ],
                [
                    0.4820, 0.4061, 2.8889, 4.0000, 0.2500, 1.1800, 0.3836, 1.0000, 0.2770,
                ],
                [
                    1.0345, 0.6519, 3.2008, 4.0000, 0.2500, 1.0000, 1.0000, 1.0000, 0.3857,
                ],
            ],
