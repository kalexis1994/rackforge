    ...
    fn default() -> Self {
        let mut piano = Self {
            ...
            cal: [
                ...
                [
                    3.5576, 2.1321, 0.9212, 2.6568, 0.2500, 0.4731, 0.2952, 1.0000, 0.4058,
                ],
                [
                    4.0000, 0.6556, 1.1017, 1.0000, 0.2500, 0.7958, 0.2500, 1.0000, 0.9942,
                ],
                [
                    0.9443, 0.9026, 4.0000, 3.9996, 0.2500, 1.0000, 1.9942, 1.0000, 0.2500,
                ],
                [
                    0.4820, 0.2500, 4.0000, 4.0000, 0.2500, 1.1800, 0.3836, 1.0000, 0.2500,
                ],
                [
                    1.0345, 0.3835, 4.0000, 4.0000, 0.2500, 1.0000, 1.0000, 1.0000, 0.2500,
                ],
            ],
